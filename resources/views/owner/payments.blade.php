...
<section style="padding-bottom: 5rem; font-family: 'Inter', sans-serif;">
    ...
    <div style="margin-bottom: 3rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
        <div>
            ...
            <p style="color: #64748b; font-size: 1rem; margin: 0;">Managing your store's payouts, completed settlements, and active balances.</p>
        </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 2rem; margin-bottom: 4rem;">
        ...
        <div style="background: #ffffff; border-radius: 24px; padding: 2rem; border: 1px solid #f1f5f9; box-shadow: 0 4px 15px rgba(0,0,0,0.02); display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <div style="font-size: 1.8rem; font-weight: 800; color: #7c3aed; line-height: 1.1; margin-bottom: 0.2rem;">
                    ${{ number_format($settledPayouts, 2) }}
                </div>
                <div style="font-size: 0.85rem; font-weight: 600; color: #64748b;">Settled Payouts</div>
            </div>
        </div>
    ...
    <div class="desktop-only" style="background: #ffffff; border-radius: 24px; padding: 2.5rem; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.03); display: none;">
        <h3 style="margin-bottom: 2rem; font-weight: 800; font-size: 1.3rem; color: #1e293b; margin-top: 0;">Completed Sales (Pending Payout)</h3>
            ...
            <table style="width: 100%; border-collapse: separate; border-spacing: 0; text-align: left; min-width: 800px;">
                <thead>
                    <tr>
                        ...
                        <th style="padding: 1.25rem 1.5rem; color: #64748b; font-size: 0.75rem; text-transform: uppercase; font-weight: 800; letter-spacing: 1px; border-bottom: 2px solid #f1f5f9;">Payout Status</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr style="transition: background 0.3s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 1.25rem 1.5rem; font-weight: 800; font-size: 1.1rem; color: #f97316; border-bottom: 1px solid #f1f5f9;">+ ${{ number_format($ownerSubtotal, 2) }}</td>
                        ...
                        <td style="padding: 1.25rem 1.5rem; border-bottom: 1px solid #f1f5f9;">
                            <span style="padding: 0.35rem 0.8rem; border-radius: 50px; font-size: 0.72rem; font-weight: 800; background: #fff7ed; color: #c2410c; text-transform: uppercase; letter-spacing: 0.5px;">
                                PENDING PAYOUT
                            </span>
                        </td>
                    </tr>
                    ...
                    @if($orders->isEmpty())
                    <tr>
                        <td colspan="5" style="padding: 6rem 1.5rem; text-align: center; color: #64748b; font-weight: 700; font-size: 0.95rem;">No pending payouts available.</td>
                    </tr>
                    @endif
                </tbody>
            </table>
    ...
    <div class="mobile-only" style="display: none;">
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            ...
            <div style="background: #ffffff; border-radius: 20px; padding: 1.5rem; border: 1px solid #f1f5f9; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        ...
                        <div style="font-weight: 800; font-size: 1.15rem; color: #f97316;">+ ${{ number_format($ownerSubtotal, 2) }}</div>
                    </div>
                    <div style="text-align: right;">
                        <div style="color: #64748b; font-size: 0.7rem; font-weight: 700; letter-spacing: 1px; margin-bottom: 0.2rem;">PAYOUT STATUS</div>
                        <span style="display: inline-block; padding: 0.25rem 0.65rem; border-radius: 50px; font-size: 0.65rem; font-weight: 800; background: #fff7ed; color: #c2410c; text-transform: uppercase;">
                            PENDING PAYOUT
                        </span>
                    </div>
                </div>
            ...
            @endforeach
            @if($orders->isEmpty())
            <div style="background: #ffffff; border-radius: 20px; padding: 4rem 1.5rem; text-align: center; color: #64748b; font-weight: 700; border: 1px solid #f1f5f9;">No pending payouts available.</div>
            @endif
        </div>
    </div>
