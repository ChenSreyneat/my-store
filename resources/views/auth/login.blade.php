    ...
    <div class="animate-fade-in" style="width: 100%; max-width: 450px; position: relative; z-index: 2; margin: 0 auto;">
        ...
        <div class="glass-card" style="padding: 0; overflow: hidden;">
            ...
            <div style="padding: 2rem 2rem 1rem 2rem; display: flex; justify-content: center; align-items: center;">
                <h2 style="margin: 0; font-family: 'Outfit', sans-serif;">Welcome <span class="text-gradient">Back</span></h2>
            </div>
            ...
            <div style="padding: 1rem 2rem 2.5rem 2rem;">
                <form action="{{ route('login') }}" method="POST" style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <div style="position: relative;">
                            <input type="password" id="login-password" name="password" placeholder="Enter your password" required style="padding-right: 2.5rem;">
                            <button type="button" onclick="togglePassword('login-password', this)" style="position: absolute; right: 1rem; top: 50%; transform: translateY(-50%); background: none; border: none; color: var(--text-dim); cursor: pointer; padding: 0; display: flex; align-items: center; justify-content: center; width: 18px; height: 18px;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; font-weight: 500; cursor: pointer; text-transform: none; letter-spacing: normal; margin: 0; opacity: 1;">
                    ...
                    <!-- Submit -->
                    <button type="submit" class="btn btn-primary" style="width: 100%; justify-content: center; padding: 1rem; font-size: 1rem;">Sign In</button>

                    <!-- Divider -->
                    <div style="display: flex; align-items: center; gap: 1rem; margin: 0.5rem 0;">
                        <div style="flex: 1; height: 1px; background: var(--glass-border);"></div>
                        <span style="font-size: 0.8rem; color: var(--text-dim); text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">OR CONTINUE WITH</span>
                        <div style="flex: 1; height: 1px; background: var(--glass-border);"></div>
                    </div>

                    <!-- Socials -->
                    <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                        <a href="{{ route('auth.google') }}" class="btn btn-outline" style="flex: 1; min-width: 130px; justify-content: center; padding: 0.8rem;">
                        ...
                        <a href="#" class="btn btn-outline" style="flex: 1; min-width: 130px; justify-content: center; padding: 0.8rem;">
